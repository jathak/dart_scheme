  ...
  void importAll(Frame __env) {
    addPrimitive(__env, const SchemeSymbol('forward'), (__exprs, __env) {
      if (__exprs[0] is! Number)
        throw new SchemeException('Argument of invalid type passed to forward.');
      turtle.show();
      var __value = undefined;
      this.forward(__exprs[0].toJS());
      return __value;
    }, 1);
    __env.bindings[const SchemeSymbol('fd')] = __env.bindings[const SchemeSymbol('forward')];
    __env.hidden[const SchemeSymbol('fd')] = true;
    addPrimitive(__env, const SchemeSymbol('backward'), (__exprs, __env) {
      if (__exprs[0] is! Number)
        throw new SchemeException('Argument of invalid type passed to backward.');
      turtle.show();
      var __value = undefined;
      this.backward(__exprs[0].toJS());
      return __value;
    }, 1);
    __env.bindings[const SchemeSymbol('back')] = __env.bindings[const SchemeSymbol('backward')];
    __env.hidden[const SchemeSymbol('back')] = true;
    __env.bindings[const SchemeSymbol('bk')] = __env.bindings[const SchemeSymbol('backward')];
    ...
    __env.bindings[const SchemeSymbol('lt')] = __env.bindings[const SchemeSymbol('left')];
    ...
    __env.bindings[const SchemeSymbol('rt')] = __env.bindings[const SchemeSymbol('right')];
    ...
    addPrimitive(__env, const SchemeSymbol('setposition'), (__exprs, __env) {
      if (__exprs[0] is! Number || __exprs[1] is! Number)
        throw new SchemeException('Argument of invalid type passed to setposition.');
      turtle.show();
      var __value = undefined;
    ...
    __env.bindings[const SchemeSymbol('goto')] = __env.bindings[const SchemeSymbol('setposition')];
    __env.hidden[const SchemeSymbol('goto')] = true;
    addPrimitive(__env, const SchemeSymbol('setheading'), (__exprs, __env) {
      if (__exprs[0] is! Number)
        throw new SchemeException('Argument of invalid type passed to setheading.');
      turtle.show();
      var __value = undefined;
      this.setHeading(__exprs[0].toJS());
      return __value;
    }, 1);
    __env.bindings[const SchemeSymbol('seth')] = __env.bindings[const SchemeSymbol('setheading')];
    ...
    __env.bindings[const SchemeSymbol('pu')] = __env.bindings[const SchemeSymbol('penup')];
    ...
    __env.bindings[const SchemeSymbol('pd')] = __env.bindings[const SchemeSymbol('pendown')];
    ...
    __env.bindings[const SchemeSymbol('end-fill')] = __env.bindings[const SchemeSymbol('end_fill')];
    ...
    addPrimitive(__env, const SchemeSymbol("pensize"), (__exprs, __env) {
      if (__exprs[0] is! Number)
        throw new SchemeException('Argument of invalid type passed to pensize.');
      turtle.show();
      var __value = undefined;
    ...
    addPrimitive(__env, const SchemeSymbol('turtle-grid'), (__exprs, __env) {
      if ((__exprs[0] is! Number || !(__exprs[0] as Number).isInteger) ||
        ...
        throw new SchemeException('Argument of invalid type passed to turtle-grid.');
      var __value = undefined;
    ...
    addPrimitive(__env, const SchemeSymbol('turtle-canvas'), (__exprs, __env) {
      if ((__exprs[0] is! Number || !(__exprs[0] as Number).isInteger) ||
          (__exprs[1] is! Number || !(__exprs[1] as Number).isInteger))
        throw new SchemeException('Argument of invalid type passed to turtle-canvas.');
      var __value = undefined;
      this.setCanvasSize(__exprs[0].toJS().toInt(), __exprs[1].toJS().toInt());
      return __value;
    }, 2);
    addPrimitive(__env, const SchemeSymbol("pixel"), (__exprs, __env) {
      if (__exprs[0] is! Number || __exprs[1] is! Number || __exprs[2] is! Expression)
    ...
    addPrimitive(__env, const SchemeSymbol("pixelsize"), (__exprs, __env) {
      if ((__exprs[0] is! Number || !(__exprs[0] as Number).isInteger))
        throw new SchemeException('Argument of invalid type passed to pixelsize.');
      var __value = undefined;
    ...
    addVariablePrimitive(__env, const SchemeSymbol('unsupported'), (__exprs, __env) {
      var __value = undefined;
      this.unsupported(__exprs, __env);
      return __value;
    }, 0, -1);
    __env.bindings[const SchemeSymbol('speed')] = __env.bindings[const SchemeSymbol('unsupported')];
    ...
    __env.bindings[const SchemeSymbol('st')] = __env.bindings[const SchemeSymbol('unsupported')];
    ...
    __env.bindings[const SchemeSymbol('ht')] = __env.bindings[const SchemeSymbol('unsupported')];
